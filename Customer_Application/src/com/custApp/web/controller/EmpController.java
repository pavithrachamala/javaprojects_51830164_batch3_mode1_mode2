...
/*@PostConstruct
	public void init(){
		empService.addEmp(new Emp("devi", "devi@gmail.com", "devi234", "admin", true));
		empService.addEmp(new Emp("sai", "sai@gmail.com", "sai123", "manager", true));
		empService.addEmp(new Emp("tej", "tej@gmail.com", "tej345", "user", true));
}*/
